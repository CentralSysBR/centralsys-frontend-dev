...
export function ReciboVenda({
  ...
  return (
    <div className="fixed inset-0 bg-[#F8FAFC] z-[200] flex flex-col items-center p-4 md:p-8 overflow-y-auto animate-in fade-in duration-300">
      ...
      {/* Papel do Recibo (O que será impresso) - Adicionado a classe recibo-content para o CSS */}
      <div className="recibo-content w-full max-w-[350px] bg-white p-6 shadow-2xl rounded-sm border-t-8 border-[#1A2B3C] print:shadow-none print:border-none print:p-0 font-mono text-sm text-gray-800">
        ...
        <div className="space-y-2 mb-6">
          ...
          {itens.map((item, index) => (
            <div key={item.id || index} className="flex flex-col text-[11px]">
